 ...
 */
function FreeSingleSelectivity(options) {
 ...
 * Methods.
 */
var callSuper = Selectivity.inherits(FreeSingleSelectivity, {
...
module.exports = Selectivity.InputTypes.FreeSingle = FreeSingleSelectivity;
